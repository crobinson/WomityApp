...
@end
@interface invitar2ViewController : UIViewController<UITextFieldDelegate, AmigosCrearViewControllerDelegate, ABPeoplePickerNavigationControllerDelegate, ABPersonViewControllerDelegate, ABNewPersonViewControllerDelegate, ABUnknownPersonViewControllerDelegate, UIWebViewDelegate, UITextViewDelegate, UITabBarControllerDelegate, ContactsViewControllerDelegate, popViewControllerDelegate>
{
