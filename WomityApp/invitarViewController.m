...
@implementation invitarViewController
@synthesize reloj;
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {   
    ...
    if([[json objectForKey:@"boolInvitarWomityYEnviar"] isEqualToString:@"true"] && ![[[NSUserDefaults standardUserDefaults] valueForKey:@"descripcion"] isEqualToString:@"invitar"]){
       /* UIAlertView *alerta = [[UIAlertView alloc] initWithTitle:@"Mensaje" message:[json objectForKey:@"strMensaje"] delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        ...
        UIAlertView *alerta = [[UIAlertView alloc] initWithTitle:@"Mensaje" message:@"Tu womit ha sido creado y enviado a tus contactos con éxito" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alerta show];
